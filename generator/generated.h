...
void clin_init_orig_funs() {
	clin_o_clBuildProgram = (clin_t_clBuildProgram)clin_get_orig_fun("clBuildProgram");
	clin_o_clCloneKernel = (clin_t_clCloneKernel)clin_get_orig_fun("clCloneKernel");
	clin_o_clCompileProgram = (clin_t_clCompileProgram)clin_get_orig_fun("clCompileProgram");
	clin_o_clCreateBuffer = (clin_t_clCreateBuffer)clin_get_orig_fun("clCreateBuffer");
	clin_o_clCreateCommandQueue = (clin_t_clCreateCommandQueue)clin_get_orig_fun("clCreateCommandQueue");
	clin_o_clCreateCommandQueueWithProperties = (clin_t_clCreateCommandQueueWithProperties)clin_get_orig_fun("clCreateCommandQueueWithProperties");
	clin_o_clCreateContext = (clin_t_clCreateContext)clin_get_orig_fun("clCreateContext");
	clin_o_clCreateContextFromType = (clin_t_clCreateContextFromType)clin_get_orig_fun("clCreateContextFromType");
	clin_o_clCreateFromGLBuffer = (clin_t_clCreateFromGLBuffer)clin_get_orig_fun("clCreateFromGLBuffer");
	clin_o_clCreateFromGLRenderbuffer = (clin_t_clCreateFromGLRenderbuffer)clin_get_orig_fun("clCreateFromGLRenderbuffer");
	clin_o_clCreateFromGLTexture = (clin_t_clCreateFromGLTexture)clin_get_orig_fun("clCreateFromGLTexture");
	clin_o_clCreateFromGLTexture2D = (clin_t_clCreateFromGLTexture2D)clin_get_orig_fun("clCreateFromGLTexture2D");
	clin_o_clCreateFromGLTexture3D = (clin_t_clCreateFromGLTexture3D)clin_get_orig_fun("clCreateFromGLTexture3D");
	clin_o_clCreateImage = (clin_t_clCreateImage)clin_get_orig_fun("clCreateImage");
	clin_o_clCreateImage2D = (clin_t_clCreateImage2D)clin_get_orig_fun("clCreateImage2D");
	clin_o_clCreateImage3D = (clin_t_clCreateImage3D)clin_get_orig_fun("clCreateImage3D");
	clin_o_clCreateKernel = (clin_t_clCreateKernel)clin_get_orig_fun("clCreateKernel");
	clin_o_clCreateKernelsInProgram = (clin_t_clCreateKernelsInProgram)clin_get_orig_fun("clCreateKernelsInProgram");
	clin_o_clCreatePipe = (clin_t_clCreatePipe)clin_get_orig_fun("clCreatePipe");
	clin_o_clCreateProgramWithBinary = (clin_t_clCreateProgramWithBinary)clin_get_orig_fun("clCreateProgramWithBinary");
	clin_o_clCreateProgramWithBuiltInKernels = (clin_t_clCreateProgramWithBuiltInKernels)clin_get_orig_fun("clCreateProgramWithBuiltInKernels");
	clin_o_clCreateProgramWithIL = (clin_t_clCreateProgramWithIL)clin_get_orig_fun("clCreateProgramWithIL");
	clin_o_clCreateProgramWithSource = (clin_t_clCreateProgramWithSource)clin_get_orig_fun("clCreateProgramWithSource");
	clin_o_clCreateSampler = (clin_t_clCreateSampler)clin_get_orig_fun("clCreateSampler");
	clin_o_clCreateSamplerWithProperties = (clin_t_clCreateSamplerWithProperties)clin_get_orig_fun("clCreateSamplerWithProperties");
	clin_o_clCreateSubBuffer = (clin_t_clCreateSubBuffer)clin_get_orig_fun("clCreateSubBuffer");
	clin_o_clCreateSubDevices = (clin_t_clCreateSubDevices)clin_get_orig_fun("clCreateSubDevices");
	clin_o_clCreateUserEvent = (clin_t_clCreateUserEvent)clin_get_orig_fun("clCreateUserEvent");
	clin_o_clEnqueueAcquireGLObjects = (clin_t_clEnqueueAcquireGLObjects)clin_get_orig_fun("clEnqueueAcquireGLObjects");
	clin_o_clEnqueueBarrier = (clin_t_clEnqueueBarrier)clin_get_orig_fun("clEnqueueBarrier");
	clin_o_clEnqueueBarrierWithWaitList = (clin_t_clEnqueueBarrierWithWaitList)clin_get_orig_fun("clEnqueueBarrierWithWaitList");
	clin_o_clEnqueueCopyBuffer = (clin_t_clEnqueueCopyBuffer)clin_get_orig_fun("clEnqueueCopyBuffer");
	clin_o_clEnqueueCopyBufferRect = (clin_t_clEnqueueCopyBufferRect)clin_get_orig_fun("clEnqueueCopyBufferRect");
	clin_o_clEnqueueCopyBufferToImage = (clin_t_clEnqueueCopyBufferToImage)clin_get_orig_fun("clEnqueueCopyBufferToImage");
	clin_o_clEnqueueCopyImage = (clin_t_clEnqueueCopyImage)clin_get_orig_fun("clEnqueueCopyImage");
	clin_o_clEnqueueCopyImageToBuffer = (clin_t_clEnqueueCopyImageToBuffer)clin_get_orig_fun("clEnqueueCopyImageToBuffer");
	clin_o_clEnqueueFillBuffer = (clin_t_clEnqueueFillBuffer)clin_get_orig_fun("clEnqueueFillBuffer");
	clin_o_clEnqueueFillImage = (clin_t_clEnqueueFillImage)clin_get_orig_fun("clEnqueueFillImage");
	clin_o_clEnqueueMapBuffer = (clin_t_clEnqueueMapBuffer)clin_get_orig_fun("clEnqueueMapBuffer");
	clin_o_clEnqueueMapImage = (clin_t_clEnqueueMapImage)clin_get_orig_fun("clEnqueueMapImage");
	clin_o_clEnqueueMarker = (clin_t_clEnqueueMarker)clin_get_orig_fun("clEnqueueMarker");
	clin_o_clEnqueueMarkerWithWaitList = (clin_t_clEnqueueMarkerWithWaitList)clin_get_orig_fun("clEnqueueMarkerWithWaitList");
	clin_o_clEnqueueMigrateMemObjects = (clin_t_clEnqueueMigrateMemObjects)clin_get_orig_fun("clEnqueueMigrateMemObjects");
	clin_o_clEnqueueNDRangeKernel = (clin_t_clEnqueueNDRangeKernel)clin_get_orig_fun("clEnqueueNDRangeKernel");
	clin_o_clEnqueueNativeKernel = (clin_t_clEnqueueNativeKernel)clin_get_orig_fun("clEnqueueNativeKernel");
	clin_o_clEnqueueReadBuffer = (clin_t_clEnqueueReadBuffer)clin_get_orig_fun("clEnqueueReadBuffer");
	clin_o_clEnqueueReadBufferRect = (clin_t_clEnqueueReadBufferRect)clin_get_orig_fun("clEnqueueReadBufferRect");
	clin_o_clEnqueueReadImage = (clin_t_clEnqueueReadImage)clin_get_orig_fun("clEnqueueReadImage");
	clin_o_clEnqueueReleaseGLObjects = (clin_t_clEnqueueReleaseGLObjects)clin_get_orig_fun("clEnqueueReleaseGLObjects");
	clin_o_clEnqueueSVMFree = (clin_t_clEnqueueSVMFree)clin_get_orig_fun("clEnqueueSVMFree");
	clin_o_clEnqueueSVMMap = (clin_t_clEnqueueSVMMap)clin_get_orig_fun("clEnqueueSVMMap");
	clin_o_clEnqueueSVMMemFill = (clin_t_clEnqueueSVMMemFill)clin_get_orig_fun("clEnqueueSVMMemFill");
	clin_o_clEnqueueSVMMemcpy = (clin_t_clEnqueueSVMMemcpy)clin_get_orig_fun("clEnqueueSVMMemcpy");
	clin_o_clEnqueueSVMMigrateMem = (clin_t_clEnqueueSVMMigrateMem)clin_get_orig_fun("clEnqueueSVMMigrateMem");
	clin_o_clEnqueueSVMUnmap = (clin_t_clEnqueueSVMUnmap)clin_get_orig_fun("clEnqueueSVMUnmap");
	clin_o_clEnqueueTask = (clin_t_clEnqueueTask)clin_get_orig_fun("clEnqueueTask");
	clin_o_clEnqueueUnmapMemObject = (clin_t_clEnqueueUnmapMemObject)clin_get_orig_fun("clEnqueueUnmapMemObject");
	clin_o_clEnqueueWaitForEvents = (clin_t_clEnqueueWaitForEvents)clin_get_orig_fun("clEnqueueWaitForEvents");
	clin_o_clEnqueueWriteBuffer = (clin_t_clEnqueueWriteBuffer)clin_get_orig_fun("clEnqueueWriteBuffer");
	clin_o_clEnqueueWriteBufferRect = (clin_t_clEnqueueWriteBufferRect)clin_get_orig_fun("clEnqueueWriteBufferRect");
	clin_o_clEnqueueWriteImage = (clin_t_clEnqueueWriteImage)clin_get_orig_fun("clEnqueueWriteImage");
	clin_o_clFinish = (clin_t_clFinish)clin_get_orig_fun("clFinish");
	clin_o_clFlush = (clin_t_clFlush)clin_get_orig_fun("clFlush");
	clin_o_clGetCommandQueueInfo = (clin_t_clGetCommandQueueInfo)clin_get_orig_fun("clGetCommandQueueInfo");
	clin_o_clGetContextInfo = (clin_t_clGetContextInfo)clin_get_orig_fun("clGetContextInfo");
	clin_o_clGetDeviceAndHostTimer = (clin_t_clGetDeviceAndHostTimer)clin_get_orig_fun("clGetDeviceAndHostTimer");
	clin_o_clGetDeviceIDs = (clin_t_clGetDeviceIDs)clin_get_orig_fun("clGetDeviceIDs");
	clin_o_clGetDeviceInfo = (clin_t_clGetDeviceInfo)clin_get_orig_fun("clGetDeviceInfo");
	clin_o_clGetEventInfo = (clin_t_clGetEventInfo)clin_get_orig_fun("clGetEventInfo");
	clin_o_clGetEventProfilingInfo = (clin_t_clGetEventProfilingInfo)clin_get_orig_fun("clGetEventProfilingInfo");
	clin_o_clGetExtensionFunctionAddress = (clin_t_clGetExtensionFunctionAddress)clin_get_orig_fun("clGetExtensionFunctionAddress");
	clin_o_clGetExtensionFunctionAddressForPlatform = (clin_t_clGetExtensionFunctionAddressForPlatform)clin_get_orig_fun("clGetExtensionFunctionAddressForPlatform");
	clin_o_clGetGLObjectInfo = (clin_t_clGetGLObjectInfo)clin_get_orig_fun("clGetGLObjectInfo");
	clin_o_clGetGLTextureInfo = (clin_t_clGetGLTextureInfo)clin_get_orig_fun("clGetGLTextureInfo");
	clin_o_clGetHostTimer = (clin_t_clGetHostTimer)clin_get_orig_fun("clGetHostTimer");
	clin_o_clGetImageInfo = (clin_t_clGetImageInfo)clin_get_orig_fun("clGetImageInfo");
	clin_o_clGetKernelArgInfo = (clin_t_clGetKernelArgInfo)clin_get_orig_fun("clGetKernelArgInfo");
	clin_o_clGetKernelInfo = (clin_t_clGetKernelInfo)clin_get_orig_fun("clGetKernelInfo");
	clin_o_clGetKernelSubGroupInfo = (clin_t_clGetKernelSubGroupInfo)clin_get_orig_fun("clGetKernelSubGroupInfo");
	clin_o_clGetKernelWorkGroupInfo = (clin_t_clGetKernelWorkGroupInfo)clin_get_orig_fun("clGetKernelWorkGroupInfo");
	clin_o_clGetMemObjectInfo = (clin_t_clGetMemObjectInfo)clin_get_orig_fun("clGetMemObjectInfo");
	clin_o_clGetPipeInfo = (clin_t_clGetPipeInfo)clin_get_orig_fun("clGetPipeInfo");
	clin_o_clGetPlatformIDs = (clin_t_clGetPlatformIDs)clin_get_orig_fun("clGetPlatformIDs");
	clin_o_clGetPlatformInfo = (clin_t_clGetPlatformInfo)clin_get_orig_fun("clGetPlatformInfo");
	clin_o_clGetProgramBuildInfo = (clin_t_clGetProgramBuildInfo)clin_get_orig_fun("clGetProgramBuildInfo");
	clin_o_clGetProgramInfo = (clin_t_clGetProgramInfo)clin_get_orig_fun("clGetProgramInfo");
	clin_o_clGetSamplerInfo = (clin_t_clGetSamplerInfo)clin_get_orig_fun("clGetSamplerInfo");
	clin_o_clGetSupportedImageFormats = (clin_t_clGetSupportedImageFormats)clin_get_orig_fun("clGetSupportedImageFormats");
	clin_o_clLinkProgram = (clin_t_clLinkProgram)clin_get_orig_fun("clLinkProgram");
	clin_o_clReleaseCommandQueue = (clin_t_clReleaseCommandQueue)clin_get_orig_fun("clReleaseCommandQueue");
	clin_o_clReleaseContext = (clin_t_clReleaseContext)clin_get_orig_fun("clReleaseContext");
	clin_o_clReleaseDevice = (clin_t_clReleaseDevice)clin_get_orig_fun("clReleaseDevice");
	clin_o_clReleaseEvent = (clin_t_clReleaseEvent)clin_get_orig_fun("clReleaseEvent");
	clin_o_clReleaseKernel = (clin_t_clReleaseKernel)clin_get_orig_fun("clReleaseKernel");
	clin_o_clReleaseMemObject = (clin_t_clReleaseMemObject)clin_get_orig_fun("clReleaseMemObject");
	clin_o_clReleaseProgram = (clin_t_clReleaseProgram)clin_get_orig_fun("clReleaseProgram");
	clin_o_clReleaseSampler = (clin_t_clReleaseSampler)clin_get_orig_fun("clReleaseSampler");
	clin_o_clRetainCommandQueue = (clin_t_clRetainCommandQueue)clin_get_orig_fun("clRetainCommandQueue");
	clin_o_clRetainContext = (clin_t_clRetainContext)clin_get_orig_fun("clRetainContext");
	clin_o_clRetainDevice = (clin_t_clRetainDevice)clin_get_orig_fun("clRetainDevice");
	clin_o_clRetainEvent = (clin_t_clRetainEvent)clin_get_orig_fun("clRetainEvent");
	clin_o_clRetainKernel = (clin_t_clRetainKernel)clin_get_orig_fun("clRetainKernel");
	clin_o_clRetainMemObject = (clin_t_clRetainMemObject)clin_get_orig_fun("clRetainMemObject");
	clin_o_clRetainProgram = (clin_t_clRetainProgram)clin_get_orig_fun("clRetainProgram");
	clin_o_clRetainSampler = (clin_t_clRetainSampler)clin_get_orig_fun("clRetainSampler");
	clin_o_clSVMAlloc = (clin_t_clSVMAlloc)clin_get_orig_fun("clSVMAlloc");
	clin_o_clSVMFree = (clin_t_clSVMFree)clin_get_orig_fun("clSVMFree");
	clin_o_clSetCommandQueueProperty = (clin_t_clSetCommandQueueProperty)clin_get_orig_fun("clSetCommandQueueProperty");
	clin_o_clSetDefaultDeviceCommandQueue = (clin_t_clSetDefaultDeviceCommandQueue)clin_get_orig_fun("clSetDefaultDeviceCommandQueue");
	clin_o_clSetEventCallback = (clin_t_clSetEventCallback)clin_get_orig_fun("clSetEventCallback");
	clin_o_clSetKernelArg = (clin_t_clSetKernelArg)clin_get_orig_fun("clSetKernelArg");
	clin_o_clSetKernelArgSVMPointer = (clin_t_clSetKernelArgSVMPointer)clin_get_orig_fun("clSetKernelArgSVMPointer");
	clin_o_clSetKernelExecInfo = (clin_t_clSetKernelExecInfo)clin_get_orig_fun("clSetKernelExecInfo");
	clin_o_clSetMemObjectDestructorCallback = (clin_t_clSetMemObjectDestructorCallback)clin_get_orig_fun("clSetMemObjectDestructorCallback");
	clin_o_clSetProgramReleaseCallback = (clin_t_clSetProgramReleaseCallback)clin_get_orig_fun("clSetProgramReleaseCallback");
	clin_o_clSetProgramSpecializationConstant = (clin_t_clSetProgramSpecializationConstant)clin_get_orig_fun("clSetProgramSpecializationConstant");
	clin_o_clSetUserEventStatus = (clin_t_clSetUserEventStatus)clin_get_orig_fun("clSetUserEventStatus");
	clin_o_clUnloadCompiler = (clin_t_clUnloadCompiler)clin_get_orig_fun("clUnloadCompiler");
	clin_o_clUnloadPlatformCompiler = (clin_t_clUnloadPlatformCompiler)clin_get_orig_fun("clUnloadPlatformCompiler");
	clin_o_clWaitForEvents = (clin_t_clWaitForEvents)clin_get_orig_fun("clWaitForEvents");
}
